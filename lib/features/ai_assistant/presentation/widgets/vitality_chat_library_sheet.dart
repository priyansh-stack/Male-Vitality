// lib/features/ai_assistant/presentation/widgets/vitality_chat_library_sheet.dart
//
...
class VitalityChatLibrarySheet extends StatelessWidget {
  final VitalityCopilotCubit cubit;
  final VitalityCopilotState state;

  const VitalityChatLibrarySheet({
    super.key,
    required this.cubit,
    required this.state,
  });

  static void show(BuildContext context, VitalityCopilotCubit cubit, VitalityCopilotState state) {
    showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
      isScrollControlled: true,
      builder: (_) => VitalityChatLibrarySheet(cubit: cubit, state: state),
    );
  }
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.forum_outlined, color: Color(0xFF00FFCC), size: 22),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          '${state.currentUserName}\'s Consultations (${sessions.length})',
                          style: TextStyle(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: const Row(
                  ...
                  children: [
                    Icon(Icons.add_comment_outlined, color: Colors.black, size: 20),
                    SizedBox(width: 8),
                    Text(
                      'Start New Chat',
                      style: TextStyle(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Every conversation you have with your AI Copilot is saved to your private library.',
